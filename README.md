...
⑥ `geoip:cn` 源采用 [亚太互联网络信息中心（APNIC）](http://ftp.apnic.net)、[17mon/china_ip_list](https://github.com/17mon/china_ip_list) 和 [gaoyifan/china-operator-ip](https://github.com/gaoyifan/china-operator-ip) 组合
